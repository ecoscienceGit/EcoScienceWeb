        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
          <div class="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div class="md:flex md:justify-between">
              ...
              <!-- Sidebar -->
              <aside class="relative my-12 md:my-0 md:w-64 md:mr-12 lg:mr-20 md:shrink-0">
                <div class="sticky top-28">
                      ...
                      <div class="w-full">
                        ...
                        <div class="relative flex items-center">
                          ...
                          <button type="submit" class="absolute inset-0 right-auto" aria-label="Search">
                            <svg class="w-4 h-4 fill-current text-gray-400 mx-3 shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button class="flex items-center justify-between text-lg font-medium text-gray-900 w-full my-4 md:hidden" @click="sidebarNavOpen = !sidebarNavOpen">
                    ...
                    <svg class="w-3 h-3 fill-current text-blue-600 shrink-0 ml-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <nav class="md:block" :class="{ 'hidden' : !sidebarNavOpen }">
                    <ul class="font-medium -my-2">
                      <!-- 1st level -->
                      <li class="py-2">
                        <a class="flex items-center hover:underline" href="#0" @click.prevent="sidebarLinkOpen = !sidebarLinkOpen" aria-haspopup="true" :aria-expanded="sidebarLinkOpen">
                          <div class="flex items-center grow">
                            <svg class="w-4 h-4 fill-current text-blue-600 mr-3 shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="font-normal -mb-1 mt-1 ml-2 pl-5 border-l border-gray-300" :class="{ 'hidden': !sidebarLinkOpen }">
                          <li class="py-1">
                            <a class="text-gray-600 hover:underline" href="#installation">Installation</a>
                          </li>
                          <li class="py-1">
                            <a class="text-gray-600 hover:underline" href="#quick">Quick start</a>
                          </li>
                          <li class="py-1">
                            <a class="text-gray-600 hover:underline" href="#folder">Folder content</a>
                          </li>
                        </ul>
                      </li>
                      <li class="py-2">
...
import DocumentationContent from './../partials/DocumentationContent.vue'
